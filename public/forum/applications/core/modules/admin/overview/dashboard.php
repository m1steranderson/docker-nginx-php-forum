...
class _dashboard extends \IPS\Dispatcher\Controller
{
	...
	public function whatsNew()
	{
		...
		\IPS\Member::loggedIn()->members_bitoptions['has_new_acp_features'] = TRUE;
		\IPS\Member::loggedIn()->save();

		\IPS\Db::i()->delete( 'core_members_feature_seen', array( 'member_id=?', \IPS\Member::loggedIn()->member_id ) );

		if( \IPS\Member::loggedIn()->hasAcpRestriction( \IPS\Application::load( 'core' ), \IPS\Application\Module::get( 'core', 'overview' ), 'view_dashboard' ) )
		{
