...
class _Group
{
	...
	public function getDescription( $data )
	{
		if ( $data['groups'] )
		{
			...
			{
				return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_group_desc', NULL, array( 'sprintf' => array( \IPS\Member::loggedIn()->language()->formatList( $humanGroups ) ) ) );
			}
		}
