...
class _Content
{
	...
	public function getDescription( $filters )
	{
		if ( ! empty( $filters['content_count_score'] ) and $filters['content_count_score'] > 0 )
		{
			...
			{
				case 'gt':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_content_gt_desc', NULL, array( 'sprintf' => array( $filters['content_count_score'] ) ) );
				break;
				case 'lt':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_content_lt_desc', NULL, array( 'sprintf' => array( $filters['content_count_score'] ) ) );
				break;
				case 'eq':
					return \IPS\Member::loggedIn()->language()->addToStack( 'member_filter_core_content_eq_desc', NULL, array( 'sprintf' => array( $filters['content_count_score'] ) ) );
				break;
			}
		}
