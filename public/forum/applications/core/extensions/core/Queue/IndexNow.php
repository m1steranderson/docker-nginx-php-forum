...
class _IndexNow
{
	...
	public function getProgress( $data, $offset )
	{
		if( isset( $data['type']))
		{
			return array( 'text' => \IPS\Member::loggedIn()->language()->addToStack( 'indexnow_s_submitting', NULL, array( 'sprintf' => array( \IPS\Member::loggedIn()->language()->addToStack( $data['type'], FALSE ), ) ) ), 'complete' => 0 );
		}
		else
		{
