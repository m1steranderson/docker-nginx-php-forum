...
class _System
{
	...
	{
		\IPS\Api\Webhook::fire( 'member_create', $member );
	...
	public function onDelete( $member )
	{
		...
		foreach ( array(
            ...
            array( 'core_members_feature_seen', 'member_id' ),
            array( 'core_saved_charts', 'chart_member' ),
            array( 'core_members_known_devices', 'member_id' ),
            array( 'core_members_known_ip_addresses', 'member_id' ),
		...
		\IPS\Api\Webhook::fire( 'member_delete', $member );
	}
	...
	public function onProfileUpdate( $member, $changes )
	{
		...
		if( \count( $changes ) )
		{
			...
			\IPS\Api\Webhook::fire( 'member_edited', $params );
		}
	}
}