	...
	\IPS\Content\Anonymous
{
	...
	public static function formElements( $item=NULL, \IPS\Node\Model $container=NULL )
	{
		...
		if ( $fieldsClass::fixedFieldFormShow( 'record_image' ) )
		{
			...
			$formElements['record_image'] = new \IPS\Helpers\Form\Upload( 'record_image', ( ( $item and $item->record_image ) ? \IPS\File::get( 'cms_Records', $item->record_image ) : NULL ), FALSE, array( 'image' => $dims, 'storageExtension' => 'cms_Records', 'multiple' => false, 'allowStockPhotos' => true ), NULL, NULL, NULL, 'record_image' );
		}
	...
	public function canEdit( $member=NULL )
	{
		...
		if( $this->container()->modPermission( 'edit', $member, \get_called_class() ) )
		{
			return TRUE;
		}
