...
final class Warning
{
    ...
    public static function warnOnce(string $errorMessage, int $warningId, ?int $messageLevel = null)
    {
    ...
    public static function warn(string $errorMessage, int $warningId, ?int $messageLevel = null)
    {
        $messageLevel = $messageLevel ?? E_USER_WARNING;
