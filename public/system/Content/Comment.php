...
abstract class _Comment extends \IPS\Content
{
	...
	public function delete()
	{
		...
		if ( \IPS\IPS::classUsesTrait( $this->item(), 'IPS\Content\Solvable' ) and isset( $itemClass::$databaseColumnMap['solved_comment_id'] ) )
		{
			/* Reset item */
	...
	public function webhookFilters()
	{
		...
		$filters['hidden'] = ( ( (bool) $this->hidden() ) or ( (bool) $item->hidden() ) );
