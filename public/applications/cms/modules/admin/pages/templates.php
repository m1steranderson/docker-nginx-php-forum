...
class _templates extends \IPS\Dispatcher\Controller
{
	...
	public function databaseTemplateGroupOptions()
	{
		...
		if ( \count( $databases ) )
		{
			...
			$form->addMessage( \IPS\Member::loggedIn()->language()->addToStack( 'cms_database_template_used_in', NULL, array( 'sprintf' => array( \IPS\Member::loggedIn()->language()->formatList( $names ) ) ) ), 'ipsMessage ipsMessage_info' );
		}
